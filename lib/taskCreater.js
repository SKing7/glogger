...
function getTargetUrl(config) {
    ...
    return 'http://10.16.28.75:3000/?{"dataUrl":"' + decodeURIComponent(pageAlias) + '","charts":[{"type":"line","rounding":"off","title":"' + pageTitle + '","note":"' + note + '"}'
        + (graphType == 2 ? ',{"type":"line","rounding":"off","title":"' + pageTitle + '","note":"' + note + '","series":[' + (series ? series: 2) + ']}' : '' )
        + ']}'
}
